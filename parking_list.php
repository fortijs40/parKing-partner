...
<body>
    ...
    <div class="container2">
        ...
        <div class="parking-list">
            <?php foreach ($parkingData as $parkingSpot) { ?>
                <div class="parking-space">
                    <div class="first-line-info">
                        <div class="info-left">
                            <h2><?php echo $parkingSpot['spot_name']," "; 
                            ...
                            ?></h2>
                            <p>Time: <?php echo date('H:i', strtotime($parkingSpot['start_time'])) . " - " . date('H:i', strtotime($parkingSpot['end_time']));?></p>
                        </div>
                        <div class="info-right">
                            <p class="status">Status:</p>
                            <h2 class="status">0/<?php echo $parkingSpot['max_spot_count']; ?></h2>
                        </div>
                    </div>
                    <div class="second-line-info">
                        <p><b>Address:</b> <?php echo $parkingSpot['spot_address']; ?></p>
                        ...
                        <div class="button-container">
                            <form action="parkingspot_details.php" method="post">
                                <input type='hidden' name='spot_id' value='<?php echo $parkingSpot['spot_id']?>'>
                                <input type='hidden' name='spot_name' value='<?php echo $parkingSpot['spot_name']?>'>
                                <input type='hidden' name='start_time' value='<?php echo $parkingSpot['start_time']?>'>
                                <input type='hidden' name='end_time' value='<?php echo $parkingSpot['end_time']?>'>
                                <input type='hidden' name='spot_address' value='<?php echo $parkingSpot['spot_address']?>'>
                                <input type='hidden' name='max_spot_count' value='<?php echo $parkingSpot['max_spot_count']?>'>
                                <input type='hidden' name='price' value='<?php echo $parkingSpot['price']?>'>
                                <input type='hidden' name='add_info' value='<?php echo $parkingSpot['add_info']?>'>
                                <input type='hidden' name='isDisabled' value='<?php echo $parkingSpot['is_disabled']?>'>
                                <input type='hidden' name='isPremium' value='<?php echo $parkingSpot['is_premium']?>'>
