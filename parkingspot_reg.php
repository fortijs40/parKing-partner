...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO reservations(partner_id, spot_type, spot_name, spot_address, start_time, end_time,
                             price, max_spots_count, is_premium, is_disabled)
